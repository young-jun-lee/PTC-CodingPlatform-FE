export default {
	...
	text1: "Project Tech Conferences (PTC) is hosting its second coding challenge! Over a period of four weeks, PTC will roll out weekly questions for contestants to solve. To inspire young coders to rise to the challenge, PTC’s competition is free to enter and features prizes that contestants can compete for! Participants with any level of coding experience are encouraged to participate.",
	title2: "Eligibility Rules",
	text2_1:
		"During the 2020-2021 school year, participants must have been a K-12 or CÉGEP student studying in Canada.",
	text2_2: "Participants must create a PTC account to enter the competition.",
	text2_2a:
		"If a participant created an account for the 2020 PTC Coding Challenge, we ask that they create a new account.",
	...
	text3_2:
		"Participants must submit their work by 11:59 PM EDT on the following Sunday to receive recognition for their submissions.",
	text3_3:
	...
	text3_5:
		"Winners will be contacted one (1) week after the contest closes via e-mail.",
	title4: "Point System",
