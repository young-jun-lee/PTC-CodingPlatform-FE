            ...
            <br></br> */}
				...
				<div className='box box6'>
					...
					<div className='text technical-issues'>
						If you experience technical issues with the website that
						prevent you from submitting before the weekly deadline,
						please email your issue and all unsuccessful submissions
						to <u>coding.challenge@projecttechconferences.com</u> in
						a <b>single email</b>.
					</div>
					...
					<ul className='technical-issues'>
						<li className='text'>
							The email is sent <b>less than 2 hours</b> before
							the deadline (i.e. Sunday between 9:59 PM and 11:59
							PM).
						</li>
						<li className='text'>
